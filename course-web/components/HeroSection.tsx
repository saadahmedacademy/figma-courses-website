...
export const HeroSection = () => {
  ...
  <div className="container flex ml-auto justify-around md:pl-24 pb-7 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 pt-6 px-4 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-bold text-start">
      Learn new skills {""}
       <br className="hidden lg:inline-block" />
       online with ease
      </h1>
      <p className="mb-8 leading-relaxed text-gray-900 text-start ">
      Discover a wide range of courses covering a variety of <br className="hidden lg:inline-block"/>
